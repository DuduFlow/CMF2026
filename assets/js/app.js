    ...
    const courseNoteLinks = new Map([
      ...
      ["時代趨勢：自媒體事件營銷", "learning-notes.html?v=20260718-2#note-d5-02"],
      ["壽險常青樹 - 超高淨值客戶銷售解析", "learning-notes.html?v=20260718-2#note-d5-03"],
      ["用家辦思維撬動超高淨值客戶", "learning-notes.html?v=20260718-2#note-d5-04"],
      ["法商智慧：高客風險破解", "learning-notes.html?v=20260718-2#note-d5-05"],
      ["認知突圍：業績倍增心法", "learning-notes.html?v=20260718-2#note-d6-01"],
      ["長期主義：20 年保險路，從個人績優到團隊領袖", "learning-notes.html?v=20260718-2#note-d6-02"],
      ["團隊經營與績優文化建設", "learning-notes.html?v=20260718-2#note-d6-03"],
      ["00 後組織發展：年輕一代的團隊成長密碼", "learning-notes.html?v=20260718-2#note-d6-04"],
      ["投保心理學：洞察人性，經營未來 - AI 保險時代下的破局", "learning-notes.html?v=20260718-2#note-d6-05"],
      ["家族保單拓客要領", "learning-notes.html?v=20260718-2#note-d6-06"],
      ["IP 打造與直播獲客", "learning-notes.html?v=20260718-2#note-d6-07"],
      ["職業轉型與保險從業成長", "learning-notes.html?v=20260718-2#note-d6-08"],
      ["企業家客戶的銷售邏輯", "learning-notes.html?v=20260718-2#note-d6-09"],
      ["內容 IP 獲客：從晨間直播到百萬粉絲，保險人長效私域經營", "learning-notes.html?v=20260718-2#note-d7-01"],
      ["人生經營三部曲 - 保險的智慧", "learning-notes.html?v=20260718-2#note-d7-02"],
      ["持續打造績優與高客深度經營", "learning-notes.html?v=20260718-2#note-d7-03"],
      ["如何構建保險新生態", "learning-notes.html?v=20260718-2#note-d7-04"],
      ["財務視角下的保險本質", "learning-notes.html?v=20260718-2#note-d7-05"],
      ["國學與保險營銷", "learning-notes.html?v=20260718-2#note-d7-06"],
      ["構建保險新生態", "learning-notes.html?v=20260718-2#note-d7-07"],
      ["柔韌的力量：女性企業家的破局與成長", "learning-notes.html?v=20260718-2#note-d7-08"]
    ]);
    ...
    function setupTabs() {
      ...
      $("#prepShortcut").addEventListener("click", () => { window.location.href = "learning-notes.html?v=20260718-2"; });
